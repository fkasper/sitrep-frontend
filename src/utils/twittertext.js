...
twttr.txt.autoLinkEntities = function(text, entities, options) {
  ...
  options.hashtagUrlBase = options.hashtagUrlBase || "/twitter/category/%23";
  options.cashtagClass = options.cashtagClass || DEFAULT_CASHTAG_CLASS;
  options.cashtagUrlBase = options.cashtagUrlBase || "/twitter/category/%24";
  options.listClass = options.listClass || DEFAULT_LIST_CLASS;
  options.usernameClass = options.usernameClass || DEFAULT_USERNAME_CLASS;
  options.usernameUrlBase = options.usernameUrlBase || "/twitter/user/";
  options.listUrlBase = options.listUrlBase || "/twitter/list/";
